...
from retrievers.colbert.infra.config.config import ColBERTConfig

import retrievers.colbert.utils.distributed as distributed

from retrievers.colbert.infra.run import Run
from retrievers.colbert.infra.launcher import print_memory_stats
from retrievers.colbert.modeling.checkpoint import Checkpoint
from retrievers.colbert.data.collection import Collection
...
from retrievers.colbert.utils.utils import flatten, print_message
...
class CollectionIndexer():
    ...
    def train(self, shared_lists):
        ...
        print("Processing concatenate_and_split_sample...")
