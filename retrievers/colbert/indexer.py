...
from retrievers.colbert.utils.utils import create_directory, print_message
from retrievers.colbert.indexing.collection_indexer import encode
...
class Indexer:
    ...
    def index(self, name, collection, overwrite=False, bsize=64):
        ...
        if index_does_not_exist or overwrite != 'reuse':
            self.launch_process(collection)
